...
class ProductRepositoryTest extends \Raiadrogasil\Test\BaseTestCase
{
    private $request;
    ...
    {
        $entity = Mockery::mock(\App\Domain\Entities\Product::class)->makePartial();
        ...
        $mockRepository = Mockery::mock(\App\Repositories\ProductRepository::class)->makePartial();
    ...
    public function testModel()
    {
        ...
        $this->assertEquals(\App\Domain\Entities\Product::class, $result);
    }
}
